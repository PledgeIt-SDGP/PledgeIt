    ...
    <OrganizationDashboard>
      <div className="bg-gradient-to-br from-blue-50 to-orange-50 min-h-screen">
        <div className="p-8 space-y-8 max-w-7xl mx-auto">
          {/* Header Section */}
          <div className="bg-rose-50 rounded-2xl shadow-lg p-6 mb-8 ">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="flex items-center">
                <div className="border-1 border-gray-500 rounded-md mr-4">
                  <img 
                ...
                <div>
                  <div className="flex items-center">
                    <div className="bg-blue-100 text-blue-600 text-xs font-bold px-2 py-1 rounded-full mr-2">
                      DASHBOARD
                    </div>
          ...
          <div className="grid gap-6 grid-cols-1 md:grid-cols-3">
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all p-6 flex items-center transform hover:-translate-y-1 duration-300">
              <div className="bg-gradient-to-br from-orange-100 to-orange-200 p-4 rounded-2xl mr-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all p-6 flex items-center transform hover:-translate-y-1 duration-300">
              <div className="bg-gradient-to-br from-blue-100 to-blue-200 p-4 rounded-2xl mr-6">
            ...
            {/* People Impacted */}
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all p-6 flex items-center transform hover:-translate-y-1 duration-300">
              <div className="bg-gradient-to-br from-green-100 to-green-200 p-4 rounded-2xl mr-6">
                <HeartHandshake size={32} className="text-green-600" />
              </div>
              <div>
                <p className="text-gray-500 text-sm font-medium">
                  People Impacted
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="space-y-4 overflow-y-auto max-h-96">
                {upcomingEvents.map((event) => (
                  <div key={event.id} className="p-4 border border-gray-100 rounded-xl hover:border-orange-200 hover:bg-orange-50 transition-colors ">
