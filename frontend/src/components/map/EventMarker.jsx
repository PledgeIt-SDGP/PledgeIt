...
const EventMarker = ({ event }) => {
  ...
  return (
    ...
    >
      <Popup className="relative w-64 bg-white/90 backdrop-blur-lg rounded-xl shadow-lg p-4 border border-gray-200">
        ...
        <div className="flex flex-col space-y-2">
          ...
          >
            <span className="mr-1 group-hover:text-red-700 transition-colors">
              View More
            </span>
