...
import { Building2, Globe, Mail, Phone, MapPin, Star, Award, Users, HandHeart, Sparkle, Contact, Sparkles, AlertTriangle, X } from 'lucide-react';
                            ...
                            <div className="flex items-center relative z-10">
                                ...
                                <div className="w-28 h-28 mx-10 rounded-full border-3 border-white shadow-lg overflow-hidden">
                                    {organization.logo ? (
                                        ...
                                        <Building2 className="w-full h-full text-gray-800 p-4" />
                                    )}
                                </div>
